...
class ProjectDetailPage extends StatelessWidget {
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
              CustomScrollView(
                slivers: [
                  _buildHeroAppBar(context, project, isSaved: isSaved),
    ...
    return SliverAppBar(
      ...
      actions: [
        ...
        _buildCircleButton(
          ...
          onTap: () {
            _toggleSavedProject(context, project);
          },
        ),
          ...
          children: [
            CachedNetworkImage(
              ...
              errorWidget: (context, url, error) =>
                  _buildErrorPlaceholder(color, project.category),
            ),
            Container(
  ...
  Future<void> _toggleSavedProject(
    BuildContext context,
    Project project,
  ) async {
      ...
      SnackBar(
        content: Text(
          result.success
              ...
              : (result.errorMessage ?? AppStrings.bookmarkUpdateFailed),
        ),
        backgroundColor: result.success ? null : AppColors.red500,
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: AppSpacing.sm),
              ConfidenceBadge(confidence: project.confidence, showIcon: true),
            ],
          ),
        ],
      ),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      '${AppStrings.managedBy} ${project.agencyOrDeveloper}',
                      style: AppTypography.titleMedium,
                    ),
                    const SizedBox(height: 2),
                    Text(
                      AppStrings.communityCheckInsCount(
                        project.checkIns.length,
                      ),
                      style: AppTypography.subtitle,
                    ),
                  ],
                ...
                Material(
                  ...
                  child: InkWell(
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => DeveloperProfilePage(project: project),
                      ),
                    ),
                    borderRadius: BorderRadius.circular(AppSpacing.radiusFull),
                    child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (sources.isNotEmpty) ...[
                ...
                ...sources
                    .take(3)
                    .map((source) => _buildSourceItem(context, source)),
                if (sources.length > 3)
                  Padding(
...
class _GenerateReportButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ElevatedButton.icon(
      ...
      label: Text(
        isGenerating ? '${(provider.progress * 100).toInt()}%' : 'Full Report',
      ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ...headlines
              .take(3)
              .map((headline) => _NewsHeadlineCard(headline: headline)),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) =>
                    _NewsHeadlineCard(headline: headlines[index]),
              ),
            ),
          ],
        ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text(
                      df.format(headline.publishedAt),
                      style: AppTypography.captionMedium.copyWith(
                        color: AppColors.slate400,
                      ),
                    ),
      ...
      child: Column(
        children: [
          _HighlightRow(
            ...
            title: AppStrings.expectedCompletion,
            ...
            children: [
              ...
              _DetailChip(
                ...
                label: project.isPublic
                    ? AppStrings.publicLabel
                    : AppStrings.privateLabel,
              ),
              _DetailChip(
              ...
              _DetailChip(
                ...
                label: project.expectedCompletion != null
                    ...
                    : AppStrings.noDeadline,
              ),
              _DetailChip(
                icon: Icons.people_rounded,
                label: AppStrings.checkInsCount(project.checkIns.length),
              ),
              _DetailChip(
                icon: Icons.shield_outlined,
                label:
                    '${project.confidence.label}${AppStrings.confidenceSuffix}',
              ),
            ],
          ),
        ],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: AppSpacing.xs),
          Flexible(child: Text(label, style: AppTypography.labelMedium)),
        ],
      ),
    );
  }
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: AppSpacing.sm),
                    Text(AppStrings.noCheckIns, style: AppTypography.subtitle),
                  ],
                ),
              ),
            )
  ...
  Widget build(BuildContext context) {
    return Consumer<CompareProvider>(
      builder: (context, provider, _) {
        ...
        final otherSelected = provider.selectedProjects
                ...
                onTap: () {
                  ...
                  if (provider.canCompare) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: const Text(
                          'Select another project from the home page to compare',
                        ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              AppStrings.communityDataDisclaimer,
              style: AppTypography.bodySmall.copyWith(
...
class _DeveloperBackgroundPage extends StatelessWidget {
      ...
      body: ListView(
        ...
        children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            profile?.name ?? project.agencyOrDeveloper,
                            style: AppTypography.headlineMedium,
                          ),
                          if (profile?.sources.isNotEmpty == true)
                            Text(
                              profile!.sources.first.url,
                              style: AppTypography.captionMedium.copyWith(
                                color: AppColors.indigo500,
                              ),
                            ),
          ...
          _buildSourceSection(
            ...
            sources.where((s) => s.type == SourceType.government).toList(),
          ),
          ...
          _buildSourceSection(
            ...
            'News Coverage',
            Icons.newspaper_rounded,
            sources.where((s) => s.type == SourceType.news).toList(),
          ),
          ...
          _buildSourceSection(
            ...
            sources
                .where(
                  (s) =>
                      s.type == SourceType.forum ||
                      s.type == SourceType.community,
                )
                .toList(),
          ),
  ...
  Widget _buildSourceSection(
    ...
    String title,
    IconData icon,
    List<ScrapedSource> sectionSources,
  ) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.md),
          ...sectionSources.map(
            (source) => _buildFullSourceItem(context, source),
          ),
        ],
      ),
    );
      ...
      case 'Official Sources':
        return [
          ScrapedSource(
            ...
            url: 'https://www.google.com/search?q=$devName+official',
            type: SourceType.developer,
            scrapedAt: DateTime.now(),
            snippet: 'Developer-provided URL.',
            domain: devName.toLowerCase().replaceAll(' ', '') + '.com',
          ),
          ScrapedSource(
            id: 'gen_search',
            title: 'Google Search: $devName',
            url: 'https://www.google.com/search?q=$devName',
            type: SourceType.developer,
            scrapedAt: DateTime.now(),
            snippet: 'Generated search link — manual review recommended.',
            domain: 'google.com',
          ),
        ];
      case 'Filings & Reports':
        return [
          ScrapedSource(
            ...
            scrapedAt: DateTime.now(),
            snippet:
                'Search SSM portal for company filings. Manual review required.',
            domain: 'ssm.com.my',
          ),
          ScrapedSource(
            id: 'gen_public',
            title: 'Public Reports: $devName',
            url: 'https://www.google.com/search?q=$devName+annual+report+PDF',
            type: SourceType.government,
            scrapedAt: DateTime.now(),
            snippet: 'Search for publicly available PDF reports.',
            domain: 'google.com',
          ),
        ];
      case 'News Coverage':
        return [
          ScrapedSource(
            ...
            url: 'https://news.google.com/search?q=$devName',
            type: SourceType.news,
            scrapedAt: DateTime.now(),
            snippet:
                'Google News results — review for positive/negative sentiment.',
      ...
      default:
        return [
          ScrapedSource(
            ...
            url: 'https://www.google.com/search?q=$devName+reviews',
            type: SourceType.forum,
            scrapedAt: DateTime.now(),
            snippet: 'Public search link — no ToS-restricted scraping.',
            domain: 'google.com',
          ),
        ];
    }
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: pct >= 70
                            ? AppColors.green50
                            : (pct >= 50 ? AppColors.amber50 : AppColors.red50),
                        borderRadius: BorderRadius.circular(
                          AppSpacing.radiusFull,
                        ),
                      ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  '${AppStrings.verified} ${df.format(project.lastVerified)}',
